...
if (-not(Test-Path "$repo_root/artifacts/package/release/Sharpliner.Core.43.43.43.nupkg")) {
    Write-Host "Building Sharpliner.Core nupkg for Sharpliner.CI..."
    dotnet pack --nologo "$repo_root/src/Sharpliner.Core/Sharpliner.Core.csproj" -p:PackageVersion=43.43.43 -c:Release
}
