...
/// <summary>
/// Represents the <c>DockerCompose@1</c> task with action <c>Push services</c>.
...
/// </summary>
public record DockerComposePushTask : DockerComposeTask
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DockerComposePushTask"/> class.
    /// </summary>
    public DockerComposePushTask() : base("Push services")
    {
        DisplayName = "Docker Compose push services";
    }

    /// <summary>
    /// Optional additional tags to push for service images.
    ...
    /// <summary>
    /// Optional flag that includes source tags when pushing service images.
    /// Default: <c>false</c>.
    /// </summary>
    [YamlIgnore]
    ...
    /// <summary>
    /// Optional flag that includes the <c>latest</c> tag when pushing service images.
    /// Default: <c>false</c>.
    /// </summary>
    [YamlIgnore]
