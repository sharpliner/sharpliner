...
/// <summary>
/// Class that contains references for dependencies meant for usage within the "stages" section that did not come from a deployment job.
/// </summary>
public class StageLevelDependencyVariable
{
    ...
    /// <summary>
    /// Gets a reference to a variable created by another job with the specified name.
    ...
    public StageToStageDependencyVariableReference this[string stageName, string jobName, string stepName, string variableName] => new(stageName, jobName, stepName, variableName);
}
