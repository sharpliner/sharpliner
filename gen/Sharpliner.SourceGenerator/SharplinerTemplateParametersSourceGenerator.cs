...
public class SharplinerTemplateParametersSourceGenerator : IIncrementalGenerator
{
    ...
    private static bool IsTemplateDefinitionClass(ClassDeclarationSyntax classDeclaration)
    {
        ...
        return baseType is GenericNameSyntax genericName 
            && genericName.Identifier.Text is "JobTemplateDefinition" or "StageTemplateDefinition" or "StepTemplateDefinition" or "VariableTemplateDefinition"
